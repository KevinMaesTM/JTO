...
insert into JTOTest.dbo.Countries (Name) values ('Belgiê');
insert into JTOTest.dbo.Countries (Name) values ('Nederland');

insert into JTOTest.dbo.Destinations (City, CountryID, Name, Number, Street, Zip) values ('Antwerpen', 1, 'Het MAS', 20, 'Masstraat', '2000' );

insert into JTOTest.dbo.Persons (City, CountryID, CourseResponsible, DateOfBirth, Email, GroupTourResponsible, medicalSheet, MemberHealthInsurance, Name, Number, Phone, Sex, Street, Surname, Zip) values ('Weelde', 1, 1, '1994-10-10 00:00:00', 'kevin.maes@gmail.com', 1, null, 1, 'Kevin', 60, null, 1, 'Lange Wijkstraat', 'Maes', '2381');
insert into JTOTest.dbo.Persons (City, CountryID, CourseResponsible, DateOfBirth, Email, GroupTourResponsible, medicalSheet, MemberHealthInsurance, Name, Number, Phone, Sex, Street, Surname, Zip) values ('Weelde', 1, 1, '1998-10-10 00:00:00', 'robin.maes@gmail.com', 1, null, 1, 'Robin', 60, null, 1, 'Lange Wijkstraat', 'Maes', '2381');
...
INSERT INTO JTOTest.dbo.Trainings (Name, Date, TraineeID)
VALUES ('Verantwoordelijkheid', '2023-06-01', 1), ('EHBO', '2023-05-30', 2), ('Didacthiek', '2023-07-15', 3);
